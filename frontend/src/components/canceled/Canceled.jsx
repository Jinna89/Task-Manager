  ...
  return (
    <div>
      <main className="flex-1 p-8 overflow-y-auto">
        <h1 className="text-3xl font-bold text-gray-800">Canceled Task</h1>
        <p className="mt-2 text-gray-600">See Your Canceled Task.</p>
        {CanceledList.map((item, index) => (
          <div
            key={index}
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"
          >
            <div className="mt-6 p-6 bg-white rounded-lg shadow-blue-100">
              ...
              <div className="mt-4 flex justify-between items-center gap-1 text-sm text-gray-500">
                <p className="flex items-center justify-between gap-1">
                  <MapIcon className="h-4 w-4"></MapIcon>{" "}
